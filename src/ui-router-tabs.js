  ...
  'tabs', ['$rootScope', '$state', 'uiRouterTabsConfig', function($rootScope, $state, uiRouterTabsConfig) {
    ...
    return {
      ...
      templateUrl: function(element, attributes) {
        ...
        return uiRouterTabsConfig.useCustomUiView || attributes.customUiView === 'true'
          ? 'ui-router-tabs-custom-ui-view-template.html' 
          : 'ui-router-tabs-default-template.html';
      }
    };
  }]
).run(
